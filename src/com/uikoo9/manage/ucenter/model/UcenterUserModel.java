 ...
 * ucenter_user_password			用户密码<br>
 * ucenter_user_type				用户类型<br>
 * ucenter_user_mobi				用户手机<br>
 * ucenter_user_mobi_code			用户手机验证码<br>
 * ucenter_user_mobi_code_date		用户手机验证码时间<br>
 * ucenter_user_mobi_code_confirm	用户手机验证码确认<br>
